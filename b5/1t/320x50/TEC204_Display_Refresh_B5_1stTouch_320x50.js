...
// stage content:
(lib.TEC204_Display_Refresh_B5_1stTouch_320x50 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(78.4,24.5,326.70000000000005,29.1);
// library properties:
lib.properties = {
