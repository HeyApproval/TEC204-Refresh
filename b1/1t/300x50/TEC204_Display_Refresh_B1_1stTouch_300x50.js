...
// stage content:
(lib.TEC204_Display_Refresh_B1_1stTouch_300x50 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(58.4,24.5,336.70000000000005,32.1);
// library properties:
lib.properties = {
