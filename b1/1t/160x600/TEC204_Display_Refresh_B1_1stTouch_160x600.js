...
lib.ssMetadata = [
		{name:"TEC204_Display_Refresh_B1_1stTouch_160x600_atlas_NP_1", frames: [[0,0,320,1200]]}
];
...
(lib._160x600b11t = function() {
	this.initialize(ss["TEC204_Display_Refresh_B1_1stTouch_160x600_atlas_NP_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.TEC204_Display_Refresh_B1_1stTouch_160x600 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// pic
	this.instance_5 = new lib._160x600b11t();
