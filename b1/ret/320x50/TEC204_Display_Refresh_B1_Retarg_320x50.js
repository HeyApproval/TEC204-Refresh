...
// stage content:
(lib.TEC204_Display_Refresh_B1_Retarg_320x50 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_1.setTransform(410.4,24,1,1,0,0,0,88.4,11);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(23).to({_off:false},0).to({x:321.4},13,cjs.Ease.quadOut).to({_off:true},35).wait(177));
...
p.nominalBounds = new cjs.Rectangle(78.4,24.5,336.70000000000005,28.1);
// library properties:
lib.properties = {
